...
function menu(ev) {
  ...
  //removeEventListener("click", muevemeIzq);
    document.getElementById("left").addEventListener("click", muevemeIzq.bind(ev, event));
    document.getElementById("right").addEventListener("click", muevemeDere.bind(ev, event));
}
